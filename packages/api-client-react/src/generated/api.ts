...
export const updateCurrentUser = async (updateUserInput: UpdateUserInput, options?: RequestInit): Promise<User> => {
...
export const googleLogin = async (googleLoginInput: GoogleLoginInput, options?: RequestInit): Promise<GoogleLogin200> => {

  return customFetch<GoogleLogin200>(getGoogleLoginUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGoogleLoginMutationOptions = <TError = ErrorType<ErrorResponse>,
 ...
 * @summary Log in or register with Google access token
 */
export const useGoogleLogin = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof googleLogin>>, TError,{data: BodyType<GoogleLoginInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getSendVerificationCodeUrl = () => {
  ...
  return `/api/auth/student-verification/send-code`
}

export const sendVerificationCode = async (sendVerificationCodeBody: SendVerificationCodeBody, options?: RequestInit): Promise<OkResponse> => {

  return customFetch<OkResponse>(getSendVerificationCodeUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSendVerificationCodeMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendVerificationCode>>, TError,{data: BodyType<SendVerificationCodeBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendVerificationCode>>, TError,{data: BodyType<SendVerificationCodeBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendVerificationCode>>, {data: BodyType<SendVerificationCodeBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendVerificationCodeMutationBody = BodyType<SendVerificationCodeBody>
 ...
 */
export const getVerifyStudentCodeUrl = () => {




  return `/api/auth/student-verification/verify-code`
}

export const verifyStudentCode = async (verifyStudentCodeBody: VerifyStudentCodeBody, options?: RequestInit): Promise<OkResponse> => {

  return customFetch<OkResponse>(getVerifyStudentCodeUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getVerifyStudentCodeMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyStudentCode>>, TError,{data: BodyType<VerifyStudentCodeBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof verifyStudentCode>>, TError,{data: BodyType<VerifyStudentCodeBody>}, TContext> => {

const mutationKey = ['verifyStudentCode'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof verifyStudentCode>>, {data: BodyType<VerifyStudentCodeBody>}> = (props) => {
          const {data} = props ?? {};

          return  verifyStudentCode(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type VerifyStudentCodeMutationResult = NonNullable<Awaited<ReturnType<typeof verifyStudentCode>>>
    export type VerifyStudentCodeMutationBody = BodyType<VerifyStudentCodeBody>
    export type VerifyStudentCodeMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Verify the code sent to the email
 */
export const useVerifyStudentCode = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyStudentCode>>, TError,{data: BodyType<VerifyStudentCodeBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof verifyStudentCode>>,
        TError,
        {data: BodyType<VerifyStudentCodeBody>},
        TContext
      > => {
      return useMutation(getVerifyStudentCodeMutationOptions(options));
    }
...
export const createComment = async (id: number,
    createCommentInput: CreateCommentInput, options?: RequestInit): Promise<Comment> => {
...
export const getCreateCommentMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createComment>>, TError,{id: number;data: BodyType<CreateCommentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createComment>>, TError,{id: number;data: BodyType<CreateCommentInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createComment>>, {id: number;data: BodyType<CreateCommentInput>}> = (props) => {
          const {id,data} = props ?? {};
...
export const getSectionStats = async ( options?: RequestInit): Promise<SectionStat[]> => {
...
export const getGetSectionStatsQueryOptions = <TData = Awaited<ReturnType<typeof getSectionStats>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSectionStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSectionStatsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSectionStats>>> = ({ signal }) => getSectionStats({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSectionStats>>, TError, TData> & { queryKey: QueryKey }
}

export type GetSectionStatsQueryResult = NonNullable<Awaited<ReturnType<typeof getSectionStats>>>
...
export function useGetSectionStats<TData = Awaited<ReturnType<typeof getSectionStats>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSectionStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
